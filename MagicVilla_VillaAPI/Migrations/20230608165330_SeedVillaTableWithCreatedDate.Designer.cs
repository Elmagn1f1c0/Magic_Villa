...
namespace MagicVillaVillaAPI.Migrations
{
    ...
    [Migration("20230608165330_SeedVillaTableWithCreatedDate")]
            ...
            modelBuilder.Entity("MagicVilla_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 8, 17, 53, 30, 81, DateTimeKind.Local).AddTicks(3246),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 8, 17, 53, 30, 81, DateTimeKind.Local).AddTicks(3260),
                            Details = "A serene place",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 8, 17, 53, 30, 81, DateTimeKind.Local).AddTicks(3262),
                            Details = "A serene place",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 8, 17, 53, 30, 81, DateTimeKind.Local).AddTicks(3263),
                            Details = "A serene place",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 8, 17, 53, 30, 81, DateTimeKind.Local).AddTicks(3265),
                            Details = "A serene place",
