...
namespace MagicVillaVillaAPI.Migrations
{
    ...
    [Migration("20230609181240_AddForeignKey")]
            ...
            modelBuilder.Entity("MagicVilla_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 9, 19, 12, 40, 79, DateTimeKind.Local).AddTicks(8135),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 9, 19, 12, 40, 79, DateTimeKind.Local).AddTicks(8148),
                            Details = "A serene place",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 9, 19, 12, 40, 79, DateTimeKind.Local).AddTicks(8150),
                            Details = "A serene place",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 9, 19, 12, 40, 79, DateTimeKind.Local).AddTicks(8151),
                            Details = "A serene place",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 9, 19, 12, 40, 79, DateTimeKind.Local).AddTicks(8153),
                            Details = "A serene place",
