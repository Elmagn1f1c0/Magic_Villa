...
namespace MagicVillaVillaAPI.Migrations
{
    ...
    [Migration("20230609172456_AddVillaNumber")]
            ...
            modelBuilder.Entity("MagicVilla_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 9, 18, 24, 56, 580, DateTimeKind.Local).AddTicks(6036),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 9, 18, 24, 56, 580, DateTimeKind.Local).AddTicks(6052),
                            Details = "A serene place",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 9, 18, 24, 56, 580, DateTimeKind.Local).AddTicks(6054),
                            Details = "A serene place",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 9, 18, 24, 56, 580, DateTimeKind.Local).AddTicks(6056),
                            Details = "A serene place",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 6, 9, 18, 24, 56, 580, DateTimeKind.Local).AddTicks(6057),
                            Details = "A serene place",
